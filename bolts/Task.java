...
public class Task<TResult>
{
  ...
  private static <TContinuationResult, TResult> void completeAfterTask(final Task<TContinuationResult>.TaskCompletionSource paramTask, final Continuation<TResult, Task<TContinuationResult>> paramContinuation, final Task<TResult> paramTask1, Executor paramExecutor, CancellationToken paramCancellationToken)
  {
    paramExecutor.execute(new Runnable()
    {
      public void run()
      {
        if ((this.val$ct != null) && (this.val$ct.isCancellationRequested()))
        {
          paramTask.setCancelled();
          return;
        }
        try
        {
          Task localTask = (Task)paramContinuation.then(paramTask1);
          if (localTask == null)
          {
  ...
  private static <TContinuationResult, TResult> void completeImmediately(final Task<TContinuationResult>.TaskCompletionSource paramTask, final Continuation<TResult, TContinuationResult> paramContinuation, final Task<TResult> paramTask1, Executor paramExecutor, CancellationToken paramCancellationToken)
  {
    paramExecutor.execute(new Runnable()
    {
      public void run()
      {
        ...
        try
        {
          Object localObject = paramContinuation.then(paramTask1);
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/bolts/Task.class
