  ...
  implements FragmentManager.BackStackEntry, Runnable
{
  ...
  private void ensureFragmentsAreInitialized(SparseArray<Fragment> paramSparseArray)
  {
    ...
    while (i < j)
    {
      ...
      if (localFragment.mState < 1)
      {
        this.mManager.makeActive(localFragment);
        this.mManager.moveToState(localFragment, 1, 0, 0, false);
      }
      i += 1;
    }
  }
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/android/support/v4/app/BackStackRecord.class
