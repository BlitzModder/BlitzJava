  ...
  implements Callable<Map<String, KitInfo>>
{
    ...
    throws Exception
  {
    ...
    while (localEnumeration.hasMoreElements())
    {
      ...
      {
        i = j;
        if (((ZipEntry)localObject).getName().length() > "fabric/".length())
        {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/io/fabric/sdk/android/FabricKitsFinder.class
