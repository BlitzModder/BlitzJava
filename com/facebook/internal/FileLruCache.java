...
public final class FileLruCache
{
  ...
  private void trim()
  {
    ...
    //   36: dup
    //   37: invokespecial 176	java/util/PriorityQueue:<init>	()V
    //   40: astore 11
    //   42: lconst_0
    //   43: lstore 7
    //   45: lconst_0
    ...
    //   52: invokestatic 180	com/facebook/internal/FileLruCache$BufferFile:excludeBufferFiles	()Ljava/io/FilenameFilter;
    //   55: invokevirtual 184	java/io/File:listFiles	(Ljava/io/FilenameFilter;)[Ljava/io/File;
    //   58: astore 12
    //   60: lload 5
    //   62: lstore_3
    //   63: lload 7
    ...
    //   99: dup
    //   100: aload 13
    //   102: invokespecial 186	com/facebook/internal/FileLruCache$ModifiedFile:<init>	(Ljava/io/File;)V
    //   105: astore 14
    //   107: aload 11
    //   109: aload 14
    //   111: invokevirtual 190	java/util/PriorityQueue:add	(Ljava/lang/Object;)Z
    //   114: pop
    //   115: getstatic 165	com/facebook/LoggingBehavior:CACHE	Lcom/facebook/LoggingBehavior;
    //   118: getstatic 65	com/facebook/internal/FileLruCache:TAG	Ljava/lang/String;
    //   121: new 192	java/lang/StringBuilder
    //   124: dup
    //   125: invokespecial 193	java/lang/StringBuilder:<init>	()V
    //   128: ldc -61
    //   130: invokevirtual 199	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   133: aload 14
    //   135: invokevirtual 203	com/facebook/internal/FileLruCache$ModifiedFile:getModified	()J
    //   138: invokestatic 209	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   141: invokevirtual 212	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   144: ldc -42
    //   146: invokevirtual 199	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   149: aload 14
    //   151: invokevirtual 217	com/facebook/internal/FileLruCache$ModifiedFile:getFile	()Ljava/io/File;
    //   154: invokevirtual 220	java/io/File:getName	()Ljava/lang/String;
    //   157: invokevirtual 199	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   160: invokevirtual 223	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   163: invokestatic 173	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;)V
    //   166: aload 13
    //   168: invokevirtual 226	java/io/File:length	()J
    //   171: lstore_3
    //   172: lload 7
    //   174: lload_3
    //   175: ladd
    ...
    //   205: invokevirtual 230	com/facebook/internal/FileLruCache$Limits:getByteCount	()I
    //   208: i2l
    //   209: lcmp
    //   210: ifgt +16 -> 226
    //   213: lload_3
    ...
    //   218: invokevirtual 233	com/facebook/internal/FileLruCache$Limits:getFileCount	()I
    //   221: i2l
    //   222: lcmp
    //   223: ifle +100 -> 323
    //   226: aload 11
    //   228: invokevirtual 237	java/util/PriorityQueue:remove	()Ljava/lang/Object;
    //   231: checkcast 28	com/facebook/internal/FileLruCache$ModifiedFile
    //   234: invokevirtual 217	com/facebook/internal/FileLruCache$ModifiedFile:getFile	()Ljava/io/File;
    //   237: astore 12
    //   239: getstatic 165	com/facebook/LoggingBehavior:CACHE	Lcom/facebook/LoggingBehavior;
    ...
    //   252: ldc -17
    //   254: invokevirtual 199	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   257: aload 12
    //   259: invokevirtual 220	java/io/File:getName	()Ljava/lang/String;
    //   262: invokevirtual 199	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   265: invokevirtual 223	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   268: invokestatic 173	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;)V
    //   271: lload 9
    //   273: aload 12
    //   275: invokevirtual 226	java/io/File:length	()J
    //   278: lsub
    //   279: lstore 9
    //   281: lload_3
    //   282: lconst_1
    ...
    //   284: lstore_3
    //   285: aload 12
    //   287: invokevirtual 155	java/io/File:delete	()Z
    //   290: pop
    //   291: goto -92 -> 199
    //   294: astore 12
    //   296: aload_0
    ...
    //   305: aload_0
    //   306: iconst_0
    //   307: putfield 159	com/facebook/internal/FileLruCache:isTrimInProgress	Z
    //   310: aload_0
    //   311: getfield 99	com/facebook/internal/FileLruCache:lock	Ljava/lang/Object;
    //   314: invokevirtual 242	java/lang/Object:notifyAll	()V
    //   317: aload 11
    //   319: monitorexit
    //   320: aload 12
    //   322: athrow
    ...
    throws IOException
  {
    ...
    //   20: dup
    //   21: aload 6
    //   23: invokespecial 265	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   26: astore 7
    //   28: new 267	java/io/BufferedInputStream
    //   31: dup
    //   32: aload 7
    //   34: sipush 8192
    //   37: invokespecial 270	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;I)V
    //   40: astore 7
    //   42: aload 7
    //   44: invokestatic 274	com/facebook/internal/FileLruCache$StreamHeader:readHeader	(Ljava/io/InputStream;)Lorg/json/JSONObject;
    //   47: astore 8
    //   49: aload 8
    //   51: ifnonnull +17 -> 68
    //   54: iconst_0
    //   55: ifne +8 -> 63
    //   58: aload 7
    //   60: invokevirtual 277	java/io/BufferedInputStream:close	()V
    //   63: aconst_null
    //   64: areturn
    //   65: astore_1
    //   66: aconst_null
    ...
    //   68: aload 8
    //   70: ldc 39
    //   72: invokevirtual 282	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   75: astore 9
    //   77: aload 9
    //   79: ifnull +14 -> 93
    //   82: aload 9
    //   84: aload_1
    //   85: invokevirtual 287	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   88: istore_3
    //   89: iload_3
    //   90: ifne +14 -> 104
    //   93: iconst_0
    //   94: ifne +8 -> 102
    //   97: aload 7
    //   99: invokevirtual 277	java/io/BufferedInputStream:close	()V
    //   102: aconst_null
    //   103: areturn
    //   104: aload 8
    //   106: ldc 42
    //   108: aconst_null
    //   109: invokevirtual 290	org/json/JSONObject:optString	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   112: astore_1
    //   113: aload_2
    //   114: ifnonnull +7 -> 121
    //   117: aload_1
    ...
    //   125: aload_2
    //   126: aload_1
    //   127: invokevirtual 287	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   130: istore_3
    //   131: iload_3
    //   132: ifne +14 -> 146
    //   135: iconst_0
    ...
    //   144: aconst_null
    //   145: areturn
    //   146: new 292	java/util/Date
    //   149: dup
    //   150: invokespecial 293	java/util/Date:<init>	()V
    //   153: invokevirtual 296	java/util/Date:getTime	()J
    //   156: lstore 4
    //   158: getstatic 165	com/facebook/LoggingBehavior:CACHE	Lcom/facebook/LoggingBehavior;
    //   161: getstatic 65	com/facebook/internal/FileLruCache:TAG	Ljava/lang/String;
    //   164: new 192	java/lang/StringBuilder
    //   167: dup
    //   168: invokespecial 193	java/lang/StringBuilder:<init>	()V
    //   171: ldc_w 298
    //   174: invokevirtual 199	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   177: lload 4
    //   179: invokestatic 209	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   182: invokevirtual 212	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   185: ldc_w 300
    //   188: invokevirtual 199	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   191: aload 6
    //   193: invokevirtual 220	java/io/File:getName	()Ljava/lang/String;
    //   196: invokevirtual 199	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   199: invokevirtual 223	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   202: invokestatic 173	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;)V
    //   205: aload 6
    //   207: lload 4
    //   209: invokevirtual 304	java/io/File:setLastModified	(J)Z
    //   212: pop
    //   213: iconst_1
    //   214: ifne +8 -> 222
    //   217: aload 7
    //   219: invokevirtual 277	java/io/BufferedInputStream:close	()V
    //   222: aload 7
    //   224: areturn
    //   225: astore_1
    //   226: iconst_0
    //   227: ifne +8 -> 235
    //   230: aload 7
    //   232: invokevirtual 277	java/io/BufferedInputStream:close	()V
    //   235: aload_1
    //   236: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    throws IOException
  {
    ...
    //   135: ifne +7 -> 142
    //   138: aload_3
    //   139: invokevirtual 363	java/io/BufferedOutputStream:close	()V
    //   142: aload_3
    //   143: areturn
    //   144: astore_1
    //   145: getstatic 165	com/facebook/LoggingBehavior:CACHE	Lcom/facebook/LoggingBehavior;
    //   148: iconst_5
    //   149: getstatic 65	com/facebook/internal/FileLruCache:TAG	Ljava/lang/String;
    //   152: new 192	java/lang/StringBuilder
    //   155: dup
    //   156: invokespecial 193	java/lang/StringBuilder:<init>	()V
    //   159: ldc_w 365
    //   162: invokevirtual 199	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   165: aload_1
    //   166: invokevirtual 212	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   169: invokevirtual 223	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   172: invokestatic 368	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;ILjava/lang/String;Ljava/lang/String;)V
    //   175: new 258	java/io/IOException
    //   178: dup
    //   179: aload_1
    //   180: invokevirtual 371	java/io/FileNotFoundException:getMessage	()Ljava/lang/String;
    //   183: invokespecial 335	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   186: athrow
    //   187: astore_1
    //   188: getstatic 165	com/facebook/LoggingBehavior:CACHE	Lcom/facebook/LoggingBehavior;
    //   191: iconst_5
    //   192: getstatic 65	com/facebook/internal/FileLruCache:TAG	Ljava/lang/String;
    //   195: new 192	java/lang/StringBuilder
    //   198: dup
    //   199: invokespecial 193	java/lang/StringBuilder:<init>	()V
    //   202: ldc_w 373
    //   205: invokevirtual 199	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   208: aload_1
    //   209: invokevirtual 212	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   212: invokevirtual 223	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   215: invokestatic 368	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;ILjava/lang/String;Ljava/lang/String;)V
    //   218: new 258	java/io/IOException
    //   221: dup
    //   222: aload_1
    //   223: invokevirtual 374	org/json/JSONException:getMessage	()Ljava/lang/String;
    //   226: invokespecial 335	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   229: athrow
    //   230: astore_1
    //   231: iconst_0
    //   232: ifne +7 -> 239
    //   235: aload_3
    //   236: invokevirtual 363	java/io/BufferedOutputStream:close	()V
    //   239: aload_1
    //   240: athrow
    // Local variable table:
    //   start	length	slot	name	signature
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/facebook/internal/FileLruCache.class
