    ...
    public void onClick(View paramView)
    {
      ...
      if (localSession != null) {
        if (LoginButton.this.confirmLogout)
        {
          ...
          str = LoginButton.this.getResources().getString(R.string.com_facebook_loginview_cancel_action);
      ...
      for (int i = 0;; i = 1)
      {
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            {
              localObject3 = ((ContextWrapper)localObject3).getBaseContext();
              localObject1 = str;
              if ((localObject3 instanceof Activity)) {
                localObject1 = new Session.OpenRequest((Activity)localObject3);
              }
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/facebook/widget/LoginButton.class
