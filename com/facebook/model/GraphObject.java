      ...
      extends GraphObject.Factory.ProxyBase<JSONObject>
    {
      ...
      private final Object proxyGraphObjectMethods(Object paramObject, Method paramMethod, Object[] paramArrayOfObject)
      {
        ...
        if (str.equals("getPropertyAsList")) {
          GraphObject.Factory.coerceValueToExpectedType(((JSONObject)this.state).opt((String)paramArrayOfObject[0]), GraphObjectList.class, new ParameterizedType()
          {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/facebook/model/GraphObject.class
