...
class TaskQueue
{
  ...
  private Task<Void> getTaskToAwait()
  {
    ...
    //   9: aload_0
    //   10: getfield 33	com/parse/TaskQueue:tail	Lbolts/Task;
    //   13: ifnull +32 -> 45
    //   16: aload_0
    //   17: getfield 33	com/parse/TaskQueue:tail	Lbolts/Task;
    //   20: astore_1
    //   21: aload_1
    ...
    //   30: invokevirtual 42	bolts/Task:continueWith	(Lbolts/Continuation;)Lbolts/Task;
    //   33: astore_1
    //   34: aload_0
    ...
    //   44: areturn
    //   45: aconst_null
    //   46: invokestatic 49	bolts/Task:forResult	(Ljava/lang/Object;)Lbolts/Task;
    //   49: astore_1
    //   50: goto -29 -> 21
    //   53: astore_1
    //   54: aload_0
  ...
  <T> Task<T> enqueue(Continuation<Void, Task<T>> paramContinuation)
  {
    ...
    //   21: aload_1
    //   22: aload_0
    //   23: invokespecial 64	com/parse/TaskQueue:getTaskToAwait	()Lbolts/Task;
    //   26: invokeinterface 70 2 0
    //   31: checkcast 38	bolts/Task
    //   34: astore_1
    //   35: aload_0
    //   36: iconst_2
    //   37: anewarray 38	bolts/Task
    //   40: dup
    //   41: iconst_0
    //   42: aload_2
    //   43: aastore
    ...
    //   51: invokestatic 80	bolts/Task:whenAll	(Ljava/util/Collection;)Lbolts/Task;
    //   54: putfield 33	com/parse/TaskQueue:tail	Lbolts/Task;
    //   57: aload_0
    ...
    //   67: areturn
    //   68: aconst_null
    //   69: invokestatic 49	bolts/Task:forResult	(Ljava/lang/Object;)Lbolts/Task;
    //   72: astore_2
    //   73: goto -52 -> 21
    //   76: astore_1
    //   77: aload_1
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/parse/TaskQueue.class
