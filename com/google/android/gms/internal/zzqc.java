...
public abstract interface zzqc
  extends IInterface
{
  public abstract void zza(BleDevicesResult paramBleDevicesResult)
    ...
    implements zzqc
  {
    ...
    public static zzqc zzbT(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzqc))) {
        return (zzqc)localIInterface;
      }
      ...
      implements zzqc
    {
        ...
        throws RemoteException
      {
        ...
        //   20: aload_2
        //   21: iconst_0
        //   22: invokevirtual 46	com/google/android/gms/fitness/result/BleDevicesResult:writeToParcel	(Landroid/os/Parcel;I)V
        //   25: aload_0
        //   26: getfield 18	com/google/android/gms/internal/zzqc$zza$zza:zzoo	Landroid/os/IBinder;
        //   29: iconst_1
        //   30: aload_2
        //   31: aconst_null
        //   32: iconst_1
        ...
        //   0	59	0	this	zza
        //   0	59	1	paramBleDevicesResult	BleDevicesResult
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/internal/zzqc.class
