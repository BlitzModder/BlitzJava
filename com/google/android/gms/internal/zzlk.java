  ...
  implements GameManagerState
{
  ...
  public zzlk(int paramInt1, int paramInt2, String paramString1, JSONObject paramJSONObject, Collection<PlayerInfo> paramCollection, String paramString2, int paramInt3)
  {
    this.zzabA = paramInt1;
    this.zzabz = paramInt2;
    this.zzabD = paramString1;
    this.zzabC = paramJSONObject;
    this.zzabt = paramString2;
    this.zzabu = paramInt3;
    this.zzabF = new HashMap(paramCollection.size());
    paramString1 = paramCollection.iterator();
    while (paramString1.hasNext())
    {
      paramJSONObject = (PlayerInfo)paramString1.next();
      this.zzabF.put(paramJSONObject.getPlayerId(), paramJSONObject);
    }
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return false;
        if ((this.zzabA == ((GameManagerState)paramObject).getLobbyState()) && (this.zzabz == ((GameManagerState)paramObject).getGameplayState()) && (this.zzabu == ((GameManagerState)paramObject).getMaxPlayers()) && (zzf.zza(this.zzabt, ((GameManagerState)paramObject).getApplicationName())) && (zzf.zza(this.zzabD, ((GameManagerState)paramObject).getGameStatusText())) && (zznu.zze(this.zzabC, ((GameManagerState)paramObject).getGameData()))) {}
        for (;;)
        {
          return bool;
          bool = false;
  ...
  public PlayerInfo getPlayer(String paramString)
  {
    ...
    return (PlayerInfo)this.zzabF.get(paramString);
  }
  ...
  {
    return !zznu.zze(this.zzabC, paramGameManagerState.getGameData());
  }
  
  public boolean hasGameStatusTextChanged(GameManagerState paramGameManagerState)
  {
    return !zzf.zza(this.zzabD, paramGameManagerState.getGameStatusText());
  }
  
  public boolean hasGameplayStateChanged(GameManagerState paramGameManagerState)
  {
    return this.zzabz != paramGameManagerState.getGameplayState();
  }
  
  public boolean hasLobbyStateChanged(GameManagerState paramGameManagerState)
  {
    return this.zzabA != paramGameManagerState.getLobbyState();
  }
  ...
  public boolean hasPlayerDataChanged(String paramString, GameManagerState paramGameManagerState)
  {
    ...
    do
    {
      ...
      bool1 = bool2;
    } while (!zznu.zze(localPlayerInfo.getPlayerData(), paramString.getPlayerData()));
    return false;
  }
  ...
  public int hashCode()
  {
    return zzw.hashCode(new Object[] { Integer.valueOf(this.zzabA), Integer.valueOf(this.zzabz), this.zzabF, this.zzabD, this.zzabC, this.zzabt, Integer.valueOf(this.zzabu) });
  }
}


/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/internal/zzlk.class
