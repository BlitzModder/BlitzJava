...
{
  private static final String zzPx = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' INTEGER NOT NULL, '%s' TEXT NOT NULL, '%s' TEXT NOT NULL, '%s' INTEGER);", new Object[] { "hits2", "hit_id", "hit_time", "hit_url", "hit_string", "hit_app_id" });
  private static final String zzPy = String.format("SELECT MAX(%s) FROM %s WHERE 1;", new Object[] { "hit_time", "hits2" });
  private final zzaj zzPA = new zzaj(zziT());
  private final zzaj zzPB = new zzaj(zziT());
  ...
  zzj(zzf paramzzf)
  {
    super(paramzzf);
    String str = zzjz();
    this.zzPz = new zza(paramzzf.getContext(), str);
  }
  
  private static String zzB(Map<String, String> paramMap)
  {
    com.google.android.gms.common.internal.zzx.zzy(paramMap);
  ...
  {
    com.google.android.gms.common.internal.zzx.zzy(paramzzab);
    Object localObject = new Uri.Builder();
  ...
  SQLiteDatabase getWritableDatabase()
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = this.zzPz.getWritableDatabase();
  ...
  {
    com.google.android.gms.common.internal.zzx.zzcG(paramString1);
    com.google.android.gms.common.internal.zzx.zzcG(paramString2);
    zzje();
    zziS();
  ...
  {
    com.google.android.gms.common.internal.zzx.zzcG(paramString);
    zzje();
    zziS();
  ...
  {
    com.google.android.gms.common.internal.zzx.zzy(paramzzh);
    zzje();
    zziS();
    SQLiteDatabase localSQLiteDatabase = getWritableDatabase();
    String str = zzB(paramzzh.zzn());
    ContentValues localContentValues = new ContentValues();
    localContentValues.put("app_uid", Long.valueOf(paramzzh.zzjm()));
    localContentValues.put("cid", paramzzh.getClientId());
    localContentValues.put("tid", paramzzh.zzjn());
    if (paramzzh.zzjo()) {}
    for (int i = 1;; i = 0)
    {
      localContentValues.put("adid", Integer.valueOf(i));
      localContentValues.put("hits_count", Long.valueOf(paramzzh.zzjp()));
  ...
  Map<String, String> zzbf(String paramString)
  {
  ...
  Map<String, String> zzbg(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return new HashMap(0);
    }
  ...
  public void zzc(zzab paramzzab)
  {
    ...
    if (str.length() > 8192)
    {
      zziU().zza(paramzzab, "Hit length exceeds the maximum allowed size");
      return;
    }
    zzjy();
    SQLiteDatabase localSQLiteDatabase = getWritableDatabase();
    ...
    localContentValues.put("hit_time", Long.valueOf(paramzzab.zzla()));
    localContentValues.put("hit_app_id", Integer.valueOf(paramzzab.zzkY()));
  ...
  public int zzjw()
  {
    ...
    int i = getWritableDatabase().delete("hits2", "hit_time < ?", new String[] { Long.toString(zziT().currentTimeMillis() - 2592000000L) });
  ...
  public long zzjx()
  {
    zziS();
    zzje();
    return zza(zzPy, null, 0L);
  }
  
  public void zzm(List<Long> paramList)
  {
    com.google.android.gms.common.internal.zzx.zzy(paramList);
    zziS();
    zzje();
  ...
  public List<Long> zzo(long paramLong)
  {
    ...
    //   1: astore 5
    //   3: aload_0
    //   4: invokevirtual 291	com/google/android/gms/analytics/internal/zzj:zziS	()V
    //   7: aload_0
    //   8: invokevirtual 262	com/google/android/gms/analytics/internal/zzj:zzje	()V
    //   11: lload_1
    //   12: lconst_0
    //   13: lcmp
    //   14: ifgt +7 -> 21
    //   17: invokestatic 544	java/util/Collections:emptyList	()Ljava/util/List;
    //   20: areturn
    //   21: aload_0
    ...
    //   25: astore 4
    //   27: new 546	java/util/ArrayList
    //   30: dup
    //   31: invokespecial 547	java/util/ArrayList:<init>	()V
    //   34: astore 7
    //   36: ldc_w 549
    //   39: iconst_1
    ...
    //   51: astore 6
    //   53: lload_1
    //   54: invokestatic 504	java/lang/Long:toString	(J)Ljava/lang/String;
    //   57: astore 8
    //   59: aload 4
    //   61: ldc 25
    //   63: iconst_1
    ...
    //   76: aload 6
    //   78: aload 8
    //   80: invokevirtual 553	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   83: astore 4
    //   85: aload 4
    //   87: astore 5
    //   89: aload 5
    ...
    //   117: invokestatic 330	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   120: invokeinterface 556 2 0
    //   125: pop
    //   126: aload 5
    //   128: astore 4
    //   130: aload 5
    //   132: invokeinterface 559 1 0
    //   137: istore_3
    //   138: iload_3
    //   139: ifne -36 -> 103
    //   142: aload 5
    ...
    //   167: ldc_w 561
    //   170: aload 6
    //   172: invokevirtual 242	com/google/android/gms/analytics/internal/zzj:zzd	(Ljava/lang/String;Ljava/lang/Object;)V
    //   175: aload 5
    //   177: ifnull -23 -> 154
    //   180: aload 5
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (localCursor.moveToFirst())
          {
            ...
            localObject1 = localCursor;
            ((List)localObject5).add(new zzab(this, zzbf(str1), l, zzam.zzbu(str2), paramLong, i));
            localObject1 = localCursor;
  ...
  public List<zzh> zzr(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 262	com/google/android/gms/analytics/internal/zzj:zzje	()V
    //   4: aload_0
    //   5: invokevirtual 291	com/google/android/gms/analytics/internal/zzj:zziS	()V
    //   8: aload_0
    ...
    //   19: astore 7
    //   21: aload_0
    //   22: invokevirtual 189	com/google/android/gms/analytics/internal/zzj:zziV	()Lcom/google/android/gms/analytics/internal/zzr;
    //   25: invokevirtual 597	com/google/android/gms/analytics/internal/zzr:zzkz	()I
    //   28: istore_3
    //   29: aload 8
    //   31: astore 7
    //   33: aload 9
    ...
    //   80: iconst_0
    //   81: lload_1
    //   82: invokestatic 296	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   85: aastore
    //   86: aconst_null
    //   87: aconst_null
    //   88: aconst_null
    //   89: iload_3
    //   90: invokestatic 601	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   93: invokevirtual 553	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   96: astore 8
    //   98: aload 8
    //   100: astore 7
    //   102: new 546	java/util/ArrayList
    //   105: dup
    //   106: invokespecial 547	java/util/ArrayList:<init>	()V
    //   109: astore 9
    //   111: aload 8
    //   113: astore 7
    //   115: aload 8
    ...
    //   129: aload 8
    //   131: iconst_0
    //   132: invokeinterface 571 2 0
    //   137: astore 10
    //   139: aload 8
    //   141: astore 7
    //   143: aload 8
    //   145: iconst_1
    //   146: invokeinterface 571 2 0
    //   151: astore 11
    //   153: aload 8
    //   155: astore 7
    //   157: aload 8
    //   159: iconst_2
    //   160: invokeinterface 575 2 0
    //   165: ifeq +133 -> 298
    //   168: iconst_1
    //   169: istore 6
    //   171: aload 8
    ...
    //   191: aload 8
    //   193: iconst_4
    //   194: invokeinterface 571 2 0
    //   199: invokevirtual 603	com/google/android/gms/analytics/internal/zzj:zzbg	(Ljava/lang/String;)Ljava/util/Map;
    //   202: astore 12
    //   204: aload 8
    //   206: astore 7
    //   208: aload 10
    //   210: invokestatic 382	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   213: ifne +15 -> 228
    //   216: aload 8
    //   218: astore 7
    //   220: aload 11
    //   222: invokestatic 382	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   225: ifeq +79 -> 304
    //   228: aload 8
    //   230: astore 7
    //   232: aload_0
    ...
    //   236: aload 10
    //   238: aload 11
    //   240: invokevirtual 607	com/google/android/gms/analytics/internal/zzj:zzc	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    //   243: aload 8
    //   245: astore 7
    //   247: aload 8
    //   249: invokeinterface 559 1 0
    //   254: ifne -129 -> 125
    //   257: aload 8
    //   259: astore 7
    //   261: aload 9
    //   263: invokeinterface 233 1 0
    //   268: iload_3
    ...
    //   276: aload_0
    //   277: ldc_w 609
    //   280: invokevirtual 612	com/google/android/gms/analytics/internal/zzj:zzbd	(Ljava/lang/String;)V
    //   283: aload 8
    //   285: ifnull +10 -> 295
    //   288: aload 8
    ...
    //   306: astore 7
    //   308: aload 9
    //   310: new 314	com/google/android/gms/analytics/internal/zzh
    //   313: dup
    //   314: lload_1
    //   315: aload 10
    //   317: aload 11
    ...
    //   321: lload 4
    //   323: aload 12
    //   325: invokespecial 615	com/google/android/gms/analytics/internal/zzh:<init>	(JLjava/lang/String;Ljava/lang/String;ZJLjava/util/Map;)V
    //   328: invokeinterface 556 2 0
    //   333: pop
    //   334: goto -91 -> 243
    //   337: astore 9
    //   339: aload 8
    ...
    //   348: ldc_w 587
    //   351: aload 8
    //   353: invokevirtual 271	com/google/android/gms/analytics/internal/zzj:zze	(Ljava/lang/String;Ljava/lang/Object;)V
    //   356: aload 8
    //   358: athrow
    //   359: astore 8
    //   361: aload 7
    ...
    extends SQLiteOpenHelper
  {
    ...
    private boolean zza(SQLiteDatabase paramSQLiteDatabase, String paramString)
    {
      ...
      //   67: astore_1
      //   68: aload_0
      //   69: getfield 13	com/google/android/gms/analytics/internal/zzj$zza:zzPC	Lcom/google/android/gms/analytics/internal/zzj;
      //   72: ldc 96
      //   74: aload_2
      //   75: aload 5
    ...
    {
      zzx.zzbl(paramSQLiteDatabase.getPath());
    }
    ...
    public void onOpen(SQLiteDatabase paramSQLiteDatabase)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          {
            paramSQLiteDatabase.execSQL(zzj.zzjA());
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/analytics/internal/zzj.class
