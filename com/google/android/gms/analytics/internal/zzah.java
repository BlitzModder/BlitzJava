  ...
  extends zzd
{
  ...
  private final String zzKi = zza("GoogleAnalytics", zze.VERSION, Build.VERSION.RELEASE, zzam.zza(Locale.getDefault()), Build.MODEL, Build.ID);
  private final zzaj zzRI;
  
  zzah(zzf paramzzf)
  {
    super(paramzzf);
    this.zzRI = new zzaj(paramzzf.zziT());
  }
  ...
  private int zza(URL paramURL, byte[] paramArrayOfByte)
  {
    ...
    //   10: astore 7
    //   12: aload_1
    //   13: invokestatic 88	com/google/android/gms/common/internal/zzx:zzy	(Ljava/lang/Object;)Ljava/lang/Object;
    //   16: pop
    //   17: aload_2
    //   18: invokestatic 88	com/google/android/gms/common/internal/zzx:zzy	(Ljava/lang/Object;)Ljava/lang/Object;
    //   21: pop
    //   22: aload_0
    //   23: ldc 90
    //   25: aload_2
    ...
    //   34: aload_0
    //   35: invokevirtual 104	com/google/android/gms/analytics/internal/zzah:zzjd	()Z
    //   38: ifeq +17 -> 55
    //   41: aload_0
    //   42: ldc 106
    ...
    //   202: astore 7
    //   204: aload_0
    //   205: invokevirtual 149	com/google/android/gms/analytics/internal/zzah:zzip	()Lcom/google/android/gms/analytics/internal/zzb;
    //   208: invokevirtual 154	com/google/android/gms/analytics/internal/zzb:zziP	()V
    //   211: aload 8
    //   213: astore_1
    //   214: aload 6
    //   216: astore 5
  ...
  private int zzb(URL paramURL, byte[] paramArrayOfByte)
  {
    ...
    //   4: astore 5
    //   6: aload_1
    //   7: invokestatic 88	com/google/android/gms/common/internal/zzx:zzy	(Ljava/lang/Object;)Ljava/lang/Object;
    //   10: pop
    //   11: aload_2
    //   12: invokestatic 88	com/google/android/gms/common/internal/zzx:zzy	(Ljava/lang/Object;)Ljava/lang/Object;
    //   15: pop
    //   16: aload_2
    ...
    //   75: aload_0
    //   76: invokevirtual 104	com/google/android/gms/analytics/internal/zzah:zzjd	()Z
    //   79: ifeq +35 -> 114
    //   82: aload_0
    //   83: ldc -21
    ...
    //   178: aload_0
    //   179: invokevirtual 149	com/google/android/gms/analytics/internal/zzah:zzip	()Lcom/google/android/gms/analytics/internal/zzb;
    //   182: invokevirtual 154	com/google/android/gms/analytics/internal/zzb:zziP	()V
    //   185: aload_0
    //   186: ldc -100
    //   188: iload 4
  ...
  {
    if (paramzzab.zzlc()) {}
    for (paramzzab = zziV().zzko() + zziV().zzkq() + "?" + paramString;; paramzzab = zziV().zzkp() + zziV().zzkq() + "?" + paramString) {
      try
      {
  ...
  private boolean zzg(zzab paramzzab)
  {
    ...
    if (!paramzzab.zzlc())
    {
      ...
      zziU().zza(paramzzab, "Error formatting hit for upload");
    }
    label43:
    label90:
    do
    {
      do
      {
        ...
        bool = false;
        break;
        if (((String)localObject).length() > zziV().zzkd()) {
          break label90;
        }
      ...
      if (localObject == null)
      {
        zziU().zza(paramzzab, "Error formatting hit for POST upload");
        return true;
      }
      localObject = ((String)localObject).getBytes();
      if (localObject.length > zziV().zzkf())
      {
        zziU().zza(paramzzab, "Hit payload exceeds size limit");
        return true;
      }
  ...
  {
    if (paramzzab.zzlc()) {}
    for (paramzzab = zziV().zzko() + zziV().zzkq();; paramzzab = zziV().zzkp() + zziV().zzkq()) {
      try
      {
        paramzzab = new URL(paramzzab);
        return paramzzab;
  ...
  {
    return String.valueOf(paramzzab.zzkZ());
  }
  
  private URL zzll()
  {
    Object localObject = zziV().zzko() + zziV().zzkr();
    try
    {
  ...
  String zza(zzab paramzzab, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      zza(localStringBuilder, "ht", String.valueOf(paramzzab.zzla()));
    }
    ...
    zza(localStringBuilder, "qt", String.valueOf(zziT().currentTimeMillis() - paramzzab.zzla()));
    if (zziV().zzka()) {
  ...
  List<Long> zza(List<zzab> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localArrayList.add(Long.valueOf(localzzab.zzkZ()));
    }
    label129:
    paramList = zzll();
    if (paramList == null)
    ...
    {
      zza("Batched upload completed. Hits batched", Integer.valueOf(localzza.zzln()));
      return localArrayList;
    }
    zza("Network error uploading hits. status code", Integer.valueOf(i));
    if (zziV().zzku().contains(Integer.valueOf(i)))
    {
    ...
    throws IOException
  {
    ...
    paramURL.setConnectTimeout(zziV().zzkD());
    paramURL.setReadTimeout(zziV().zzkE());
    paramURL.setInstanceFollowRedirects(false);
    paramURL.setRequestProperty("User-Agent", this.zzKi);
  ...
  public List<Long> zzo(List<zzab> paramList)
  {
    boolean bool = true;
    zziS();
    zzje();
    zzx.zzy(paramList);
    int j;
    if ((zziV().zzku().isEmpty()) || (!this.zzRI.zzv(zziV().zzkn() * 1000L)))
    {
      bool = false;
      j = 0;
      if (j != 0) {
    ...
    {
      if (zziV().zzks() != zzm.zzPQ) {}
      for (int i = 1;; i = 0)
      {
        j = i;
        if (zziV().zzkt() == zzo.zzQb) {
          break;
        }
        bool = false;
        j = i;
    ...
    return zzp(paramList);
  }
  
  List<Long> zzp(List<zzab> paramList)
  {
    ...
    do
    {
      ...
      localArrayList.add(Long.valueOf(localzzab.zzkZ()));
    } while (localArrayList.size() < zziV().zzkl());
    return localArrayList;
  }
  ...
  private class zza
  {
    ...
    {
      zzx.zzy(paramzzab);
      if (this.zzRK + 1 > zzah.this.zziV().zzkm()) {
        return false;
      }
      Object localObject = zzah.this.zza(paramzzab, false);
      if (localObject == null)
      {
        zzah.this.zziU().zza(paramzzab, "Error formatting hit");
        return true;
      }
      localObject = ((String)localObject).getBytes();
      int j = localObject.length;
      if (j > zzah.this.zziV().zzke())
      {
        zzah.this.zziU().zza(paramzzab, "Hit size exceeds the maximum size limit");
        return true;
      }
      int i = j;
      if (this.zzRL.size() > 0) {
      ...
      if (i + this.zzRL.size() > zzah.this.zziV().zzkg()) {
        return false;
      }
      try
      {
        if (this.zzRL.size() > 0) {
          this.zzRL.write(zzah.zzlm());
        }
        this.zzRL.write((byte[])localObject);
        this.zzRK += 1;
        return true;
      }
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/analytics/internal/zzah.class
