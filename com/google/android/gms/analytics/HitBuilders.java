...
public class HitBuilders
{
  ...
  protected static class HitBuilder<T extends HitBuilder>
  {
    ...
    public T addPromotion(Promotion paramPromotion)
    {
      ...
      this.zzNV.add(paramPromotion);
      return this;
    }
    
    public Map<String, String> build()
    {
      HashMap localHashMap = new HashMap(this.zzNS);
      if (this.zzNT != null) {
        localHashMap.putAll(this.zzNT.build());
      }
      Iterator localIterator = this.zzNV.iterator();
      int i = 1;
      while (localIterator.hasNext())
      {
        localHashMap.putAll(((Promotion)localIterator.next()).zzaX(zzc.zzZ(i)));
        i += 1;
      }
      localIterator = this.zzNW.iterator();
      i = 1;
      while (localIterator.hasNext())
      {
        localHashMap.putAll(((Product)localIterator.next()).zzaX(zzc.zzX(i)));
        i += 1;
      }
      localIterator = this.zzNU.entrySet().iterator();
      i = 1;
      while (localIterator.hasNext())
      {
        ...
        {
          localHashMap.putAll(((Product)((Iterator)localObject).next()).zzaX(str + zzc.zzab(j)));
          j += 1;
        }
    ...
    {
      return (String)this.zzNS.get(paramString);
    }
    ...
    public final T set(String paramString1, String paramString2)
    {
      ...
      {
        this.zzNS.put(paramString1, paramString2);
        return this;
      }
    ...
    public final T setAll(Map<String, String> paramMap)
    {
      ...
      this.zzNS.putAll(new HashMap(paramMap));
      return this;
    }
    ...
    {
      this.zzNT = paramProductAction;
      return this;
    }
    
    public T setPromotionAction(String paramString)
    {
      this.zzNS.put("&promoa", paramString);
      return this;
    }
  }
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/analytics/HitBuilders.class
