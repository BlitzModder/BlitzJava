  ...
  extends IInterface
{
  ...
  public abstract void zza(zzh paramzzh, CredentialRequest paramCredentialRequest)
    throws RemoteException;
  
  public abstract void zza(zzh paramzzh, DeleteRequest paramDeleteRequest)
    throws RemoteException;
  
  public abstract void zza(zzh paramzzh, SaveRequest paramSaveRequest)
    throws RemoteException;
    ...
    implements zzi
  {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        localzzh1 = zzh.zza.zzaw(paramParcel1.readStrongBinder());
        if (paramParcel1.readInt() != 0) {
          localObject = (CredentialRequest)CredentialRequest.CREATOR.createFromParcel(paramParcel1);
        }
        zza(localzzh1, (CredentialRequest)localObject);
        paramParcel2.writeNoException();
        return true;
      case 2: 
        paramParcel1.enforceInterface("com.google.android.gms.auth.api.credentials.internal.ICredentialsService");
        localzzh2 = zzh.zza.zzaw(paramParcel1.readStrongBinder());
        localObject = localzzh1;
        if (paramParcel1.readInt() != 0) {
          localObject = (SaveRequest)SaveRequest.CREATOR.createFromParcel(paramParcel1);
        }
        zza(localzzh2, (SaveRequest)localObject);
        paramParcel2.writeNoException();
        return true;
      case 3: 
        paramParcel1.enforceInterface("com.google.android.gms.auth.api.credentials.internal.ICredentialsService");
        localzzh1 = zzh.zza.zzaw(paramParcel1.readStrongBinder());
        localObject = localzzh2;
        if (paramParcel1.readInt() != 0) {
          localObject = (DeleteRequest)DeleteRequest.CREATOR.createFromParcel(paramParcel1);
        }
        zza(localzzh1, (DeleteRequest)localObject);
        paramParcel2.writeNoException();
        return true;
      }
      paramParcel1.enforceInterface("com.google.android.gms.auth.api.credentials.internal.ICredentialsService");
      zza(zzh.zza.zzaw(paramParcel1.readStrongBinder()));
      paramParcel2.writeNoException();
      return true;
    }
      ...
      implements zzi
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/auth/api/credentials/internal/zzi$zza$zza:zzoo	Landroid/os/IBinder;
        //   34: iconst_4
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
      ...
      /* Error */
      public void zza(zzh paramzzh, CredentialRequest paramCredentialRequest)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 30	android/os/Parcel:obtain	()Landroid/os/Parcel;
        ...
        //   46: aload_0
        //   47: getfield 18	com/google/android/gms/auth/api/credentials/internal/zzi$zza$zza:zzoo	Landroid/os/IBinder;
        //   50: iconst_1
        //   51: aload_3
        //   52: aload 4
        //   54: iconst_0
      ...
      /* Error */
      public void zza(zzh paramzzh, DeleteRequest paramDeleteRequest)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 30	android/os/Parcel:obtain	()Landroid/os/Parcel;
      ...
      /* Error */
      public void zza(zzh paramzzh, SaveRequest paramSaveRequest)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 30	android/os/Parcel:obtain	()Landroid/os/Parcel;
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/auth/api/credentials/internal/zzi.class
