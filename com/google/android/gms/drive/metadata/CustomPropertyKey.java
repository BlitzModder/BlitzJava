  ...
  implements SafeParcelable
{
  ...
  CustomPropertyKey(int paramInt1, String paramString, int paramInt2)
  {
    ...
    zzx.zzb(zzaqE.matcher(paramString).matches(), "key name characters must be alphanumeric or one of .!@$%^&*()-_/");
    boolean bool1 = bool2;
    if (paramInt2 != 0) {
      if (paramInt2 != 1) {
        break label69;
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((((CustomPropertyKey)paramObject).getKey().equals(this.zzuX)) && (((CustomPropertyKey)paramObject).getVisibility() == this.mVisibility)) {}
    for (;;)
    {
      return bool;
      bool = false;
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/drive/metadata/CustomPropertyKey.class
