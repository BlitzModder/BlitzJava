  ...
  implements Parcelable.Creator<ParcelableGeofence>
{
  static void zza(ParcelableGeofence paramParcelableGeofence, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 3, paramParcelableGeofence.zzyh());
    zzb.zza(paramParcel, 4, paramParcelableGeofence.getLatitude());
    zzb.zza(paramParcel, 5, paramParcelableGeofence.getLongitude());
    zzb.zza(paramParcel, 6, paramParcelableGeofence.zzyi());
    zzb.zzc(paramParcel, 7, paramParcelableGeofence.zzyj());
    zzb.zzc(paramParcel, 8, paramParcelableGeofence.getNotificationResponsiveness());
    zzb.zzc(paramParcel, 9, paramParcelableGeofence.zzyk());
    zzb.zzI(paramParcel, paramInt);
  }
  
  public ParcelableGeofence zzeQ(Parcel paramParcel)
  {
  ...
  public ParcelableGeofence[] zzhy(int paramInt)
  {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/location/internal/zzo.class
