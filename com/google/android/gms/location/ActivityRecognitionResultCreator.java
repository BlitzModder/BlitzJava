  ...
  implements Parcelable.Creator<ActivityRecognitionResult>
{
  ...
  static void zza(ActivityRecognitionResult paramActivityRecognitionResult, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 1, paramActivityRecognitionResult.zzaKH, false);
    zzb.zzc(paramParcel, 1000, paramActivityRecognitionResult.getVersionCode());
    zzb.zza(paramParcel, 2, paramActivityRecognitionResult.zzaKI);
    zzb.zza(paramParcel, 3, paramActivityRecognitionResult.zzaKJ);
    zzb.zzc(paramParcel, 4, paramActivityRecognitionResult.zzaKK);
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/location/ActivityRecognitionResultCreator.class
