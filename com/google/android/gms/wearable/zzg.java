  ...
  implements Parcelable.Creator<ConnectionConfiguration>
{
  static void zza(ConnectionConfiguration paramConnectionConfiguration, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 8, paramConnectionConfiguration.zzGw(), false);
    zzb.zza(paramParcel, 9, paramConnectionConfiguration.zzGx());
    zzb.zza(paramParcel, 10, paramConnectionConfiguration.getNodeId(), false);
    zzb.zzI(paramParcel, paramInt);
  }
  
  public ConnectionConfiguration zzhK(Parcel paramParcel)
  {
    String str1 = null;
    boolean bool1 = false;
  ...
  public ConnectionConfiguration[] zzlh(int paramInt)
  {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/wearable/zzg.class
