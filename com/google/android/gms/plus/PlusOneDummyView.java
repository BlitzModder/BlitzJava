  ...
  extends FrameLayout
{
  ...
  public PlusOneDummyView(Context paramContext, int paramInt)
  {
    ...
    paramContext.setBackgroundDrawable(zzDc().getDrawable(paramInt));
    Point localPoint = zzjr(paramInt);
  ...
  private Point zzjr(int paramInt)
  {
    int j = 24;
    int i = 20;
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/plus/PlusOneDummyView.class
