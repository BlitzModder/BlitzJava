  ...
  implements Parcelable.Creator<ItemScopeEntity>
{
  static void zza(ItemScopeEntity paramItemScopeEntity, Parcel paramParcel, int paramInt)
  {
    ...
    Set localSet = paramItemScopeEntity.zzaZA;
    if (localSet.contains(Integer.valueOf(1))) {
      zzb.zzc(paramParcel, 1, paramItemScopeEntity.mVersionCode);
    }
    if (localSet.contains(Integer.valueOf(2))) {
      zzb.zza(paramParcel, 2, paramItemScopeEntity.zzaZB, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(3))) {
      zzb.zzb(paramParcel, 3, paramItemScopeEntity.zzaZC, true);
    }
    if (localSet.contains(Integer.valueOf(4))) {
      zzb.zza(paramParcel, 4, paramItemScopeEntity.zzaZD, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(5))) {
      zzb.zza(paramParcel, 5, paramItemScopeEntity.zzaZE, true);
    }
    if (localSet.contains(Integer.valueOf(6))) {
      zzb.zza(paramParcel, 6, paramItemScopeEntity.zzaZF, true);
    }
    if (localSet.contains(Integer.valueOf(7))) {
      zzb.zza(paramParcel, 7, paramItemScopeEntity.zzaZG, true);
    }
    if (localSet.contains(Integer.valueOf(8))) {
      zzb.zzc(paramParcel, 8, paramItemScopeEntity.zzaZH, true);
    }
    if (localSet.contains(Integer.valueOf(9))) {
      zzb.zzc(paramParcel, 9, paramItemScopeEntity.zzaZI);
    }
    if (localSet.contains(Integer.valueOf(10))) {
      zzb.zzc(paramParcel, 10, paramItemScopeEntity.zzaZJ, true);
    }
    if (localSet.contains(Integer.valueOf(11))) {
      zzb.zza(paramParcel, 11, paramItemScopeEntity.zzaZK, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(12))) {
      zzb.zzc(paramParcel, 12, paramItemScopeEntity.zzaZL, true);
    }
    if (localSet.contains(Integer.valueOf(13))) {
      zzb.zza(paramParcel, 13, paramItemScopeEntity.zzaZM, true);
    }
    if (localSet.contains(Integer.valueOf(14))) {
      zzb.zza(paramParcel, 14, paramItemScopeEntity.zzaZN, true);
    }
    if (localSet.contains(Integer.valueOf(15))) {
      zzb.zza(paramParcel, 15, paramItemScopeEntity.zzaZO, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(17))) {
      zzb.zza(paramParcel, 17, paramItemScopeEntity.zzaZQ, true);
    }
    if (localSet.contains(Integer.valueOf(16))) {
      zzb.zza(paramParcel, 16, paramItemScopeEntity.zzaZP, true);
    }
    if (localSet.contains(Integer.valueOf(19))) {
      zzb.zzc(paramParcel, 19, paramItemScopeEntity.zzaZR, true);
    }
    if (localSet.contains(Integer.valueOf(18))) {
      zzb.zza(paramParcel, 18, paramItemScopeEntity.zztN, true);
    }
    if (localSet.contains(Integer.valueOf(21))) {
      zzb.zza(paramParcel, 21, paramItemScopeEntity.zzaZT, true);
    }
    if (localSet.contains(Integer.valueOf(20))) {
      zzb.zza(paramParcel, 20, paramItemScopeEntity.zzaZS, true);
    }
    if (localSet.contains(Integer.valueOf(23))) {
      zzb.zza(paramParcel, 23, paramItemScopeEntity.zzavc, true);
    }
    if (localSet.contains(Integer.valueOf(22))) {
      zzb.zza(paramParcel, 22, paramItemScopeEntity.zzaZU, true);
    }
    if (localSet.contains(Integer.valueOf(25))) {
      zzb.zza(paramParcel, 25, paramItemScopeEntity.zzaZW, true);
    }
    if (localSet.contains(Integer.valueOf(24))) {
      zzb.zza(paramParcel, 24, paramItemScopeEntity.zzaZV, true);
    }
    if (localSet.contains(Integer.valueOf(27))) {
      zzb.zza(paramParcel, 27, paramItemScopeEntity.zzaZY, true);
    }
    if (localSet.contains(Integer.valueOf(26))) {
      zzb.zza(paramParcel, 26, paramItemScopeEntity.zzaZX, true);
    }
    if (localSet.contains(Integer.valueOf(29))) {
      zzb.zza(paramParcel, 29, paramItemScopeEntity.zzbaa, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(28))) {
      zzb.zza(paramParcel, 28, paramItemScopeEntity.zzaZZ, true);
    }
    if (localSet.contains(Integer.valueOf(31))) {
      zzb.zza(paramParcel, 31, paramItemScopeEntity.zzbac, true);
    }
    if (localSet.contains(Integer.valueOf(30))) {
      zzb.zza(paramParcel, 30, paramItemScopeEntity.zzbab, true);
    }
    if (localSet.contains(Integer.valueOf(34))) {
      zzb.zza(paramParcel, 34, paramItemScopeEntity.zzbae, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(32))) {
      zzb.zza(paramParcel, 32, paramItemScopeEntity.zzxX, true);
    }
    if (localSet.contains(Integer.valueOf(33))) {
      zzb.zza(paramParcel, 33, paramItemScopeEntity.zzbad, true);
    }
    if (localSet.contains(Integer.valueOf(38))) {
      zzb.zza(paramParcel, 38, paramItemScopeEntity.zzaKS);
    }
    ...
    if (localSet.contains(Integer.valueOf(36))) {
      zzb.zza(paramParcel, 36, paramItemScopeEntity.zzaKR);
    }
    if (localSet.contains(Integer.valueOf(37))) {
      zzb.zza(paramParcel, 37, paramItemScopeEntity.zzbaf, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(42))) {
      zzb.zza(paramParcel, 42, paramItemScopeEntity.zzbai, true);
    }
    if (localSet.contains(Integer.valueOf(43))) {
      zzb.zza(paramParcel, 43, paramItemScopeEntity.zzbaj, true);
    }
    if (localSet.contains(Integer.valueOf(40))) {
      zzb.zza(paramParcel, 40, paramItemScopeEntity.zzbag, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(41))) {
      zzb.zzc(paramParcel, 41, paramItemScopeEntity.zzbah, true);
    }
    if (localSet.contains(Integer.valueOf(46))) {
      zzb.zza(paramParcel, 46, paramItemScopeEntity.zzbam, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(47))) {
      zzb.zza(paramParcel, 47, paramItemScopeEntity.zzban, true);
    }
    if (localSet.contains(Integer.valueOf(44))) {
      zzb.zza(paramParcel, 44, paramItemScopeEntity.zzbak, true);
    }
    if (localSet.contains(Integer.valueOf(45))) {
      zzb.zza(paramParcel, 45, paramItemScopeEntity.zzbal, true);
    }
    if (localSet.contains(Integer.valueOf(51))) {
      zzb.zza(paramParcel, 51, paramItemScopeEntity.zzbar, true);
    }
    if (localSet.contains(Integer.valueOf(50))) {
      zzb.zza(paramParcel, 50, paramItemScopeEntity.zzbaq, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(49))) {
      zzb.zza(paramParcel, 49, paramItemScopeEntity.zzbap, true);
    }
    if (localSet.contains(Integer.valueOf(48))) {
      zzb.zza(paramParcel, 48, paramItemScopeEntity.zzbao, true);
    }
    if (localSet.contains(Integer.valueOf(55))) {
      zzb.zza(paramParcel, 55, paramItemScopeEntity.zzbat, true);
    }
    ...
    if (localSet.contains(Integer.valueOf(53))) {
      zzb.zza(paramParcel, 53, paramItemScopeEntity.zzIx, true);
    }
    if (localSet.contains(Integer.valueOf(52))) {
      zzb.zza(paramParcel, 52, paramItemScopeEntity.zzbas, true);
    }
    if (localSet.contains(Integer.valueOf(56))) {
      zzb.zza(paramParcel, 56, paramItemScopeEntity.zzbau, true);
    }
    zzb.zzI(paramParcel, i);
  }
  
  public ItemScopeEntity zzgr(Parcel paramParcel)
  {
  ...
  public ItemScopeEntity[] zzju(int paramInt)
  {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/plus/internal/model/moments/zza.class
