  ...
  implements Parcelable.Creator<DataPoint>
{
  static void zza(DataPoint paramDataPoint, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 4, paramDataPoint.zztH());
    zzb.zza(paramParcel, 5, paramDataPoint.zztD(), paramInt, false);
    zzb.zza(paramParcel, 6, paramDataPoint.getOriginalDataSource(), paramInt, false);
    zzb.zza(paramParcel, 7, paramDataPoint.zztE());
    zzb.zza(paramParcel, 8, paramDataPoint.zztF());
    zzb.zzI(paramParcel, i);
  }
  
  public DataPoint zzcM(Parcel paramParcel)
  {
  ...
  public DataPoint[] zzeL(int paramInt)
  {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/fitness/data/zzd.class
