  ...
  implements Parcelable.Creator<SensorUnregistrationRequest>
{
  static void zza(SensorUnregistrationRequest paramSensorUnregistrationRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 1, paramSensorUnregistrationRequest.zzuz(), false);
    zzb.zzc(paramParcel, 1000, paramSensorUnregistrationRequest.getVersionCode());
    zzb.zza(paramParcel, 2, paramSensorUnregistrationRequest.zzuu(), paramInt, false);
    zzb.zza(paramParcel, 3, paramSensorUnregistrationRequest.zzui(), false);
    zzb.zzI(paramParcel, i);
  }
  
  public SensorUnregistrationRequest zzdt(Parcel paramParcel)
  {
  ...
  public SensorUnregistrationRequest[] zzfu(int paramInt)
  {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/fitness/request/zzt.class
