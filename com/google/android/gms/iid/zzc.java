...
public class zzc
{
  ...
  private void zzD(Object paramObject)
  {
    synchronized (getClass())
    {
      Iterator localIterator = this.zzaKx.keySet().iterator();
      if (localIterator.hasNext())
      {
        String str = (String)localIterator.next();
        Object localObject = this.zzaKx.get(str);
        this.zzaKx.put(str, paramObject);
  ...
  public static String zzaM(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        zzaKv = localApplicationInfo.uid;
        zzaKt = ((ResolveInfo)localObject2).serviceInfo.packageName;
        localObject2 = zzaKt;
      ...
      try
      {
        ...
        zzaKt = ((ApplicationInfo)localObject1).packageName;
        zzaKv = ((ApplicationInfo)localObject1).uid;
        localObject1 = zzaKt;
      ...
      catch (PackageManager.NameNotFoundException localNameNotFoundException1)
      {
        try
        {
          ...
          zzaKt = paramContext.packageName;
          zzaKv = paramContext.uid;
          paramContext = zzaKt;
          return paramContext;
        }
    ...
    throws IOException
  {
    ...
    synchronized (getClass())
    {
      this.zzaKx.put(str, localConditionVariable);
      zza(???, paramKeyPair, str);
      localConditionVariable.block(30000L);
    }
    synchronized (getClass())
    {
      paramKeyPair = this.zzaKx.remove(str);
  ...
  private void zzdK(String paramString)
  {
    ...
    Log.w("InstanceID/Rpc", "Backoff due to " + paramString + " for " + this.zzaKD);
  }
  ...
  private void zzi(String paramString, Object paramObject)
  {
    synchronized (getClass())
    {
      Object localObject = this.zzaKx.get(paramString);
      this.zzaKx.put(paramString, paramObject);
      zzg(localObject, paramObject);
      return;
    }
  }
    ...
    throws IOException
  {
    ...
    if ((this.zzaKE != 0L) && (l <= this.zzaKE))
    {
      Log.w("InstanceID/Rpc", "Backoff mode, next request attempt: " + (this.zzaKE - l) + " interval: " + this.zzaKD);
    ...
    localIntent.setPackage(zzaKt);
    paramBundle.putString("gmsv", Integer.toString(GoogleCloudMessaging.zzaJ(this.context)));
    paramBundle.putString("osv", Integer.toString(Build.VERSION.SDK_INT));
    paramBundle.putString("app_ver", Integer.toString(InstanceID.zzaK(this.context)));
  ...
  protected void zzb(Intent paramIntent, String paramString)
  {
    ...
    boolean bool = "com.google.android.gsf".equals(zzaKt);
    ...
    if (this.zzaKy != null)
    {
      paramIntent.putExtra("google.messenger", this.zzaJg);
      paramString = Message.obtain();
      paramString.obj = paramIntent;
      try
      {
        this.zzaKy.send(paramString);
        return;
      }
    ...
    if ((paramMessage.obj instanceof Intent))
    {
      ...
      if (((Intent)localObject).hasExtra("google.messenger"))
      {
        ...
        if ((localObject instanceof MessengerCompat)) {
          this.zzaKz = ((MessengerCompat)localObject);
        }
        if ((localObject instanceof Messenger)) {
          this.zzaKy = ((Messenger)localObject);
        }
      }
      zzx((Intent)paramMessage.obj);
      return;
    }
  ...
  void zzw(Intent paramIntent)
  {
    ...
    zzdK((String)localObject1);
  }
  
  void zzx(Intent paramIntent)
  {
    if (paramIntent == null) {
      if (Log.isLoggable("InstanceID/Rpc", 3)) {
  ...
  void zzxS()
  {
    ...
    zzaM(this.context);
    this.zzaJg = new Messenger(new Handler(Looper.getMainLooper())
    {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/iid/zzc.class
