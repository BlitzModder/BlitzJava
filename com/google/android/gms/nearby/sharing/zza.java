  ...
  implements Parcelable.Creator<AppContentReceivedResult>
{
  static void zza(AppContentReceivedResult paramAppContentReceivedResult, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 2, paramAppContentReceivedResult.zzCO(), paramInt, false);
    zzb.zzc(paramParcel, 3, paramAppContentReceivedResult.getStatusCode());
    zzb.zzI(paramParcel, i);
  }
  
  public AppContentReceivedResult zzgf(Parcel paramParcel)
  {
    int i = 0;
  ...
  public AppContentReceivedResult[] zzjh(int paramInt)
  {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/nearby/sharing/zza.class
