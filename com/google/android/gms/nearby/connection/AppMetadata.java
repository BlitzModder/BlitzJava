  ...
  implements SafeParcelable
{
  ...
  private final List<AppIdentifier> zzaWc;
  
  AppMetadata(int paramInt, List<AppIdentifier> paramList)
  {
    this.mVersionCode = paramInt;
    this.zzaWc = ((List)zzx.zzb(paramList, "Must specify application identifiers"));
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/nearby/connection/AppMetadata.class
