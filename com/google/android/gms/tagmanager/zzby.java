...
class zzby
  implements zzau
{
  private static final String zzPx = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' INTEGER NOT NULL, '%s' TEXT NOT NULL,'%s' INTEGER NOT NULL);", new Object[] { "gtm_hits", "hit_id", "hit_time", "hit_url", "hit_first_send_time" });
  private final Context mContext;
  private final String zzbeA;
  private long zzbeB;
  private final int zzbeC;
  private final zzb zzbex;
  private volatile zzac zzbey;
  private final zzav zzbez;
  private zznl zzqD;
  ...
  zzby(zzav paramzzav, Context paramContext, String paramString, int paramInt)
  {
    ...
    this.zzbeA = paramString;
    this.zzbez = paramzzav;
    this.zzqD = zzno.zzrM();
    this.zzbex = new zzb(this.mContext, this.zzbeA);
    this.zzbey = new zzcx(new DefaultHttpClient(), this.mContext, new zza());
    this.zzbeB = 0L;
    this.zzbeC = paramInt;
  }
  ...
  private void zzEU()
  {
    int i = zzEV() - this.zzbeC + 1;
    if (i > 0)
    {
      List localList = zzjU(i);
  ...
  {
    SQLiteDatabase localSQLiteDatabase = zzfn("Error opening database for getNumStoredHits.");
    ...
    {
      zzbg.zzaH("Error setting HIT_FIRST_DISPATCH_TIME for hitId: " + paramLong1);
      zzq(paramLong1);
    }
  }
  
  private SQLiteDatabase zzfn(String paramString)
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = this.zzbex.getWritableDatabase();
  ...
  {
    SQLiteDatabase localSQLiteDatabase = zzfn("Error opening database for putHit");
    if (localSQLiteDatabase == null) {
      return;
    }
    ContentValues localContentValues = new ContentValues();
  ...
  public void dispatch()
  {
    ...
    {
      return;
      List localList = zzjV(40);
      if (localList.isEmpty())
      {
        zzbg.v("...nothing to dispatch");
        this.zzbez.zzav(true);
        return;
      }
      this.zzbey.zzB(localList);
    } while (zzEW() <= 0);
    zzcu.zzFs().dispatch();
  }
  ...
  int zzEV()
  {
    ...
    int i = 0;
    int j = 0;
    Object localObject5 = zzfn("Error opening database for getNumStoredHits.");
  ...
  int zzEW()
  {
    ...
    //   3: aload_0
    //   4: ldc -86
    //   6: invokespecial 174	com/google/android/gms/tagmanager/zzby:zzfn	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   9: astore_3
    //   10: aload_3
    //   11: ifnonnull +5 -> 16
    //   14: iconst_0
    ...
    //   38: aconst_null
    //   39: aconst_null
    //   40: invokevirtual 295	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   43: astore_3
    //   44: aload_3
    //   45: invokeinterface 298 1 0
    //   50: istore_2
    //   51: iload_2
    //   52: istore_1
    //   53: aload_3
    ...
    //   69: astore_3
    //   70: ldc_w 300
    //   73: invokestatic 206	com/google/android/gms/tagmanager/zzbg:zzaH	(Ljava/lang/String;)V
    //   76: aload_3
    //   77: ifnull +56 -> 133
    //   80: aload_3
    //   81: invokeinterface 287 1 0
    //   86: iconst_0
    //   87: istore_1
    //   88: goto -23 -> 65
    //   91: astore_3
  ...
  void zzf(String[] paramArrayOfString)
  {
    ...
    {
      return;
      localSQLiteDatabase = zzfn("Error opening database for deleteHits.");
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfString = this.zzbez;
        if (zzEV() == 0)
        {
          paramArrayOfString.zzav(bool);
          return;
        }
      }
  ...
  /* Error */
  List<String> zzjU(int paramInt)
  {
    // Byte code:
    //   0: new 336	java/util/ArrayList
    //   3: dup
    //   4: invokespecial 337	java/util/ArrayList:<init>	()V
    //   7: astore 6
    //   9: iload_1
    //   10: ifgt +12 -> 22
    //   13: ldc_w 339
    //   16: invokestatic 206	com/google/android/gms/tagmanager/zzbg:zzaH	(Ljava/lang/String;)V
    //   19: aload 6
    //   21: areturn
    //   22: aload_0
    //   23: ldc_w 341
    //   26: invokespecial 174	com/google/android/gms/tagmanager/zzby:zzfn	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +6 -> 37
    //   34: aload 6
    ...
    //   76: aload 4
    //   78: aload 5
    //   80: invokevirtual 349	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   83: astore 4
    //   85: aload 4
    //   87: astore_3
    //   88: aload 4
    ...
    //   111: invokestatic 192	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   114: invokeinterface 353 2 0
    //   119: pop
    //   120: aload 4
    //   122: astore_3
    //   123: aload 4
    //   125: invokeinterface 356 1 0
    //   130: istore_2
    //   131: iload_2
    //   132: ifne -34 -> 98
    //   135: aload 4
    ...
    //   182: invokestatic 206	com/google/android/gms/tagmanager/zzbg:zzaH	(Ljava/lang/String;)V
    //   185: aload 4
    //   187: ifnull -40 -> 147
    //   190: aload 4
    //   192: invokeinterface 287 1 0
    //   197: goto -50 -> 147
    //   200: astore 4
    //   202: aconst_null
    //   203: astore_3
  ...
  /* Error */
  public List<zzaq> zzjV(int paramInt)
  {
    // Byte code:
    //   0: new 336	java/util/ArrayList
    //   3: dup
    ...
    //   9: aload_0
    //   10: ldc_w 365
    //   13: invokespecial 174	com/google/android/gms/tagmanager/zzby:zzfn	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   16: astore 8
    //   18: aload 8
    //   20: ifnonnull +10 -> 30
    //   23: aload 5
    ...
    //   83: aload 6
    //   85: aload 7
    //   87: invokevirtual 349	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   90: astore 6
    //   92: aload 6
    //   94: astore 4
    //   96: new 336	java/util/ArrayList
    //   99: dup
    //   100: invokespecial 337	java/util/ArrayList:<init>	()V
    //   103: astore 7
    //   105: aload 4
    //   107: invokeinterface 280 1 0
    //   112: ifeq +54 -> 166
    //   115: aload 7
    //   117: new 367	com/google/android/gms/tagmanager/zzaq
    //   120: dup
    //   121: aload 4
    //   123: iconst_0
    //   124: invokeinterface 284 2 0
    //   129: aload 4
    //   131: iconst_1
    //   132: invokeinterface 284 2 0
    //   137: aload 4
    //   139: iconst_2
    //   140: invokeinterface 284 2 0
    //   145: invokespecial 370	com/google/android/gms/tagmanager/zzaq:<init>	(JJJ)V
    //   148: invokeinterface 353 2 0
    //   153: pop
    //   154: aload 4
    //   156: invokeinterface 356 1 0
    //   161: istore_3
    //   162: iload_3
    //   163: ifne -48 -> 115
    //   166: aload 4
    ...
    //   201: astore 5
    //   203: iload_1
    //   204: invokestatic 346	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   207: astore 9
    //   209: aload 4
    //   211: astore 5
    //   213: aload 8
    ...
    //   235: aload 6
    //   237: aload 9
    //   239: invokevirtual 349	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   242: astore 6
    //   244: aload 6
    //   246: invokeinterface 280 1 0
    //   251: ifeq +53 -> 304
    //   254: iconst_0
    //   255: istore_1
    //   256: aload 6
    //   258: checkcast 372	android/database/sqlite/SQLiteCursor
    //   261: invokevirtual 376	android/database/sqlite/SQLiteCursor:getWindow	()Landroid/database/CursorWindow;
    //   264: invokevirtual 381	android/database/CursorWindow:getNumRows	()I
    //   267: ifle +136 -> 403
    //   270: aload 7
    //   272: iload_1
    //   273: invokeinterface 385 2 0
    //   278: checkcast 367	com/google/android/gms/tagmanager/zzaq
    //   281: aload 6
    //   283: iconst_1
    //   284: invokeinterface 388 2 0
    //   289: invokevirtual 391	com/google/android/gms/tagmanager/zzaq:zzfr	(Ljava/lang/String;)V
    //   292: aload 6
    //   294: invokeinterface 356 1 0
    //   299: istore_3
    //   300: iload_3
    //   301: ifne +375 -> 676
    //   304: aload 6
    ...
    //   345: aload 6
    //   347: invokevirtual 361	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    ...
    //   356: invokestatic 206	com/google/android/gms/tagmanager/zzbg:zzaH	(Ljava/lang/String;)V
    //   359: aload 4
    //   361: astore 6
    //   363: aload 5
    //   365: ifnull -338 -> 27
    //   368: aload 5
    //   370: invokeinterface 287 1 0
    //   375: aload 4
    //   377: areturn
    //   378: astore 6
    //   380: aload 4
    ...
    //   420: checkcast 367	com/google/android/gms/tagmanager/zzaq
    //   423: invokevirtual 397	com/google/android/gms/tagmanager/zzaq:zzEH	()J
    //   426: invokestatic 183	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   429: aastore
    //   430: invokestatic 49	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   433: invokestatic 206	com/google/android/gms/tagmanager/zzbg:zzaH	(Ljava/lang/String;)V
    //   436: goto -144 -> 292
    //   439: astore 5
    //   441: aload 6
    //   443: astore 4
    ...
    //   466: aload 6
    //   468: invokevirtual 361	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    ...
    //   477: invokestatic 206	com/google/android/gms/tagmanager/zzbg:zzaH	(Ljava/lang/String;)V
    //   480: aload 4
    //   482: astore 5
    //   484: new 336	java/util/ArrayList
    //   487: dup
    //   488: invokespecial 337	java/util/ArrayList:<init>	()V
    //   491: astore 6
    //   493: iconst_0
    //   494: istore_1
    //   495: aload 4
    //   497: astore 5
    //   499: aload 7
    //   501: invokeinterface 403 1 0
    //   506: astore 7
    //   508: aload 4
    //   510: astore 5
    //   512: aload 7
    //   514: invokeinterface 408 1 0
    //   519: ifeq +42 -> 561
    //   522: aload 4
    //   524: astore 5
    //   526: aload 7
    //   528: invokeinterface 412 1 0
    //   533: checkcast 367	com/google/android/gms/tagmanager/zzaq
    //   536: astore 8
    //   538: aload 4
    //   540: astore 5
    //   542: aload 8
    //   544: invokevirtual 415	com/google/android/gms/tagmanager/zzaq:zzEJ	()Ljava/lang/String;
    //   547: invokestatic 418	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   550: istore_3
    //   551: iload_1
    //   552: istore_2
    //   553: iload_3
  ...
  int zzjw()
  {
    ...
    if (l <= this.zzbeB + 86400000L) {}
    do
    {
      return 0;
      this.zzbeB = l;
      localObject = zzfn("Error opening database for deleteStaleHits.");
    } while (localObject == null);
    int i = ((SQLiteDatabase)localObject).delete("gtm_hits", "HIT_TIME < ?", new String[] { Long.toString(this.zzqD.currentTimeMillis() - 2592000000L) });
    Object localObject = this.zzbez;
    if (zzEV() == 0) {}
    for (;;)
    {
      ((zzav)localObject).zzav(bool);
      return i;
      bool = false;
    }
  }
    ...
    implements zzcx.zza
  {
    ...
    {
      zzby.zza(zzby.this, paramzzaq.zzEH());
    }
    
    public void zzb(zzaq paramzzaq)
    {
      zzby.zza(zzby.this, paramzzaq.zzEH());
      zzbg.v("Permanent failure dispatching hitId: " + paramzzaq.zzEH());
    }
    
    public void zzc(zzaq paramzzaq)
    {
      long l = paramzzaq.zzEI();
      if (l == 0L) {
        zzby.zza(zzby.this, paramzzaq.zzEH(), zzby.zza(zzby.this).currentTimeMillis());
      }
      while (l + 14400000L >= zzby.zza(zzby.this).currentTimeMillis()) {
        return;
      }
      zzby.zza(zzby.this, paramzzaq.zzEH());
      zzbg.v("Giving up on failed hitId: " + paramzzaq.zzEH());
    }
  }
    ...
    extends SQLiteOpenHelper
  {
    ...
    private boolean zza(String paramString, SQLiteDatabase paramSQLiteDatabase)
    {
      ...
      //   73: invokestatic 71	com/google/android/gms/tagmanager/zzbg:zzaH	(Ljava/lang/String;)V
      //   76: aload_2
      //   77: ifnull +9 -> 86
      //   80: aload_2
    ...
    {
      if ((this.zzbeE) && (this.zzbeF + 3600000L > zzby.zza(zzby.this).currentTimeMillis())) {
        throw new SQLiteException("Database creation failed");
      }
      Object localObject1 = null;
      this.zzbeE = true;
      this.zzbeF = zzby.zza(zzby.this).currentTimeMillis();
      try
      {
    ...
    {
      zzal.zzbl(paramSQLiteDatabase.getPath());
    }
    ...
    public void onOpen(SQLiteDatabase paramSQLiteDatabase)
    {
      ...
      try
      {
        ...
        {
          paramSQLiteDatabase.execSQL(zzby.zzEX());
          return;
        }
      }
      finally
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/tagmanager/zzby.class
