  ...
  implements Snapshots
{
  ...
  {
    Games.zzf(paramGoogleApiClient).zza(paramSnapshot);
  }
  
  public int getMaxCoverImageSize(GoogleApiClient paramGoogleApiClient)
  {
    return Games.zzf(paramGoogleApiClient).zzwm();
  }
  
  public int getMaxDataSize(GoogleApiClient paramGoogleApiClient)
  {
    return Games.zzf(paramGoogleApiClient).zzwl();
  }
  ...
  {
    return Games.zzf(paramGoogleApiClient).zza(paramString, paramBoolean1, paramBoolean2, paramInt);
  }
    ...
    extends Games.BaseGamesApiMethodImpl<Snapshots.CommitSnapshotResult>
  {
    ...
    public Snapshots.CommitSnapshotResult zzaC(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Snapshots.DeleteSnapshotResult>
  {
    ...
    public Snapshots.DeleteSnapshotResult zzaD(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Snapshots.LoadSnapshotsResult>
  {
    ...
    public Snapshots.LoadSnapshotsResult zzaE(final Status paramStatus)
    {
      new Snapshots.LoadSnapshotsResult()
      {
        public SnapshotMetadataBuffer getSnapshots()
        {
          return new SnapshotMetadataBuffer(DataHolder.zzbJ(14));
        }
    ...
    extends Games.BaseGamesApiMethodImpl<Snapshots.OpenSnapshotResult>
  {
    ...
    public Snapshots.OpenSnapshotResult zzaF(final Status paramStatus)
    {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/games/internal/api/SnapshotsImpl.class
