  ...
  implements Quests
{
  ...
  {
    return Games.zzf(paramGoogleApiClient).zzdu(paramString);
  }
  
  public Intent getQuestsIntent(GoogleApiClient paramGoogleApiClient, int[] paramArrayOfInt)
  {
    return Games.zzf(paramGoogleApiClient).zzb(paramArrayOfInt);
  }
  ...
  public void registerQuestUpdateListener(GoogleApiClient paramGoogleApiClient, QuestUpdateListener paramQuestUpdateListener)
  {
    ...
    if (localGamesClientImpl != null) {
      localGamesClientImpl.zzc(paramGoogleApiClient.zzq(paramQuestUpdateListener));
    }
  }
  ...
  public void showStateChangedPopup(GoogleApiClient paramGoogleApiClient, String paramString)
  {
    ...
    if (paramGoogleApiClient != null) {
      paramGoogleApiClient.zzdv(paramString);
    }
  }
    ...
    extends Games.BaseGamesApiMethodImpl<Quests.AcceptQuestResult>
  {
    ...
    public Quests.AcceptQuestResult zzav(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Quests.ClaimMilestoneResult>
  {
    ...
    public Quests.ClaimMilestoneResult zzaw(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Quests.LoadQuestsResult>
  {
    ...
    public Quests.LoadQuestsResult zzax(final Status paramStatus)
    {
      new Quests.LoadQuestsResult()
      {
        public QuestBuffer getQuests()
        {
          return new QuestBuffer(DataHolder.zzbJ(paramStatus.getStatusCode()));
        }
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/games/internal/api/QuestsImpl.class
