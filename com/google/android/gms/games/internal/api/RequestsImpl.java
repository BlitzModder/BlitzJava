  ...
  implements Requests
{
  ...
  {
    return Games.zzf(paramGoogleApiClient).zza(paramInt1, paramArrayOfByte, paramInt2, paramBitmap, paramString);
  }
  ...
  public void registerRequestListener(GoogleApiClient paramGoogleApiClient, OnRequestReceivedListener paramOnRequestReceivedListener)
  {
    ...
    if (localGamesClientImpl != null) {
      localGamesClientImpl.zzd(paramGoogleApiClient.zzq(paramOnRequestReceivedListener));
    }
  }
  ...
  {
    public Requests.LoadRequestSummariesResult zzay(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Requests.LoadRequestsResult>
  {
    ...
    public Requests.LoadRequestsResult zzaz(final Status paramStatus)
    {
      new Requests.LoadRequestsResult()
      {
        public GameRequestBuffer getRequests(int paramAnonymousInt)
        {
          return new GameRequestBuffer(DataHolder.zzbJ(paramStatus.getStatusCode()));
        }
  ...
  {
    public Requests.SendRequestResult zzaA(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Requests.UpdateRequestsResult>
  {
    ...
    public Requests.UpdateRequestsResult zzaB(final Status paramStatus)
    {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/games/internal/api/RequestsImpl.class
