  ...
  implements Milestone
{
  ...
  public long getCurrentProgress()
  {
    ...
    default: 
      ...
      if (l1 < 0L)
      {
        GamesLog.zzB("MilestoneRef", "Current progress should never be negative");
        l1 = l2;
      }
      break;
    }
    for (;;)
    {
      ...
      {
        GamesLog.zzB("MilestoneRef", "Current progress should never exceed target progress");
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/games/quest/MilestoneRef.class
