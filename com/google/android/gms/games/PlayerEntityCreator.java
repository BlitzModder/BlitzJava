  ...
  implements Parcelable.Creator<PlayerEntity>
{
  static void zza(PlayerEntity paramPlayerEntity, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 6, paramPlayerEntity.zzva());
    ...
    zzb.zza(paramParcel, 15, paramPlayerEntity.zzvc(), paramInt, false);
    ...
    zzb.zza(paramParcel, 19, paramPlayerEntity.zzuZ());
    zzb.zza(paramParcel, 18, paramPlayerEntity.zzvb());
    zzb.zza(paramParcel, 21, paramPlayerEntity.getName(), false);
    zzb.zza(paramParcel, 20, paramPlayerEntity.zzuY(), false);
  ...
  public PlayerEntity[] zzfV(int paramInt)
  {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/games/PlayerEntityCreator.class
