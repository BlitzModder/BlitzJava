  ...
  implements Parcelable.Creator<AchievementEntity>
{
  static void zza(AchievementEntity paramAchievementEntity, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 9, paramAchievementEntity.zzve());
    zzb.zza(paramParcel, 10, paramAchievementEntity.zzvf(), false);
    ...
    zzb.zzc(paramParcel, 13, paramAchievementEntity.zzvg());
    zzb.zza(paramParcel, 14, paramAchievementEntity.zzvh(), false);
  ...
  public AchievementEntity zzdW(Parcel paramParcel)
  {
  ...
  public AchievementEntity[] zzfY(int paramInt)
  {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/games/achievement/AchievementEntityCreator.class
