  ...
  implements Parcelable.Creator<GameRequestEntity>
{
  static void zza(GameRequestEntity paramGameRequestEntity, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 11, paramGameRequestEntity.zzxm(), false);
    zzb.zzc(paramParcel, 12, paramGameRequestEntity.getStatus());
    zzb.zzI(paramParcel, i);
  }
  
  public GameRequestEntity zzer(Parcel paramParcel)
  {
  ...
  public GameRequestEntity[] zzgH(int paramInt)
  {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/games/request/GameRequestEntityCreator.class
