  ...
  implements Parcelable.Creator<AppContentCardEntity>
{
  static void zza(AppContentCardEntity paramAppContentCardEntity, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 2, paramAppContentCardEntity.zzvu(), false);
    zzb.zzc(paramParcel, 3, paramAppContentCardEntity.zzvj(), false);
    zzb.zza(paramParcel, 4, paramAppContentCardEntity.zzvk(), false);
    zzb.zzc(paramParcel, 5, paramAppContentCardEntity.zzvv());
    ...
    zzb.zza(paramParcel, 10, paramAppContentCardEntity.zzvw(), false);
    zzb.zza(paramParcel, 11, paramAppContentCardEntity.getTitle(), false);
    zzb.zzc(paramParcel, 12, paramAppContentCardEntity.zzvx());
  ...
  public AppContentCardEntity zzdZ(Parcel paramParcel)
  {
  ...
  public AppContentCardEntity[] zzgb(int paramInt)
  {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/games/appcontent/AppContentCardEntityCreator.class
