  ...
  implements Parcelable.Creator<AppContentAnnotationEntity>
{
  static void zza(AppContentAnnotationEntity paramAppContentAnnotationEntity, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 2, paramAppContentAnnotationEntity.zzvp(), paramInt, false);
    ...
    zzb.zza(paramParcel, 6, paramAppContentAnnotationEntity.zzvs(), false);
    zzb.zza(paramParcel, 7, paramAppContentAnnotationEntity.zzvn(), false);
    zzb.zzc(paramParcel, 8, paramAppContentAnnotationEntity.zzvo());
    zzb.zzc(paramParcel, 9, paramAppContentAnnotationEntity.zzvr());
    zzb.zza(paramParcel, 10, paramAppContentAnnotationEntity.zzvq(), false);
    zzb.zzI(paramParcel, i);
  }
  
  public AppContentAnnotationEntity zzdY(Parcel paramParcel)
  {
    int i = 0;
  ...
  public AppContentAnnotationEntity[] zzga(int paramInt)
  {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/games/appcontent/AppContentAnnotationEntityCreator.class
