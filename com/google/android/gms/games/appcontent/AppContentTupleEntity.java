  ...
  implements SafeParcelable, AppContentTuple
{
  ...
  {
    return zzw.zzx(paramAppContentTuple).zzg("Name", paramAppContentTuple.getName()).zzg("Value", paramAppContentTuple.getValue()).toString();
  }
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/games/appcontent/AppContentTupleEntity.class
