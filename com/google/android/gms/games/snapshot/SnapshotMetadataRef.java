  ...
  implements SnapshotMetadata
{
  ...
  private final Player zzaIs;
  
  public SnapshotMetadataRef(DataHolder paramDataHolder, int paramInt)
  {
    super(paramDataHolder, paramInt);
    this.zzaGs = new GameRef(paramDataHolder, paramInt);
    this.zzaIs = new PlayerRef(paramDataHolder, paramInt);
  }
  ...
  {
    return zzcu("cover_icon_image_uri");
  }
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/games/snapshot/SnapshotMetadataRef.class
