  ...
  implements SafeParcelable
{
  ...
  /* Error */
  private java.io.FileOutputStream zzpJ()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 68	com/google/android/gms/common/data/BitmapTeleporter:zzahs	Ljava/io/File;
    //   4: ifnonnull +13 -> 17
    ...
    //   19: ldc 79
    //   21: aload_0
    //   22: getfield 68	com/google/android/gms/common/data/BitmapTeleporter:zzahs	Ljava/io/File;
    ...
    //   45: putfield 36	com/google/android/gms/common/data/BitmapTeleporter:zzHf	Landroid/os/ParcelFileDescriptor;
    //   48: aload_1
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    if (this.zzHf == null)
    {
      ...
      localObject = new DataOutputStream(zzpJ());
    }
    try
    {
  ...
  public Bitmap zzpI()
  {
    Object localObject1;
    if (!this.zzahr) {
      localObject1 = new DataInputStream(new ParcelFileDescriptor.AutoCloseInputStream(this.zzHf));
    }
    try
    {
      ...
      this.zzahq = ((Bitmap)localObject2);
      this.zzahr = true;
      return this.zzahq;
    }
    catch (IOException localIOException)
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/common/data/BitmapTeleporter.class
