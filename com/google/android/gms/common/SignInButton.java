  ...
  implements View.OnClickListener
{
  ...
  private Scope[] zzaem;
  private View zzaen;
  private View.OnClickListener zzaeo = null;
  ...
  private void zza(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    //   52: aload_0
    //   53: aconst_null
    //   54: putfield 51	com/google/android/gms/common/SignInButton:zzaem	[Lcom/google/android/gms/common/api/Scope;
    //   57: aload_1
    ...
    //   78: putfield 51	com/google/android/gms/common/SignInButton:zzaem	[Lcom/google/android/gms/common/api/Scope;
    //   81: iload_3
    //   82: aload_2
    //   83: arraylength
    //   84: if_icmpge -27 -> 57
    //   87: aload_0
    //   88: getfield 51	com/google/android/gms/common/SignInButton:zzaem	[Lcom/google/android/gms/common/api/Scope;
    //   91: iload_3
  ...
  private void zzaq(Context paramContext)
  {
    ...
    try
    {
      this.zzaen = zzab.zzb(paramContext, this.mSize, this.mColor, this.zzaem);
      addView(this.zzaen);
    ...
    catch (zzg.zza localzza)
    {
      for (;;)
      {
        ...
        this.zzaen = zza(paramContext, this.mSize, this.mColor, this.zzaem);
      }
    }
  }
  ...
  {
    if ((this.zzaeo != null) && (paramView == this.zzaen)) {
  ...
  {
    setStyle(this.mSize, paramInt, this.zzaem);
  }
  
  public void setEnabled(boolean paramBoolean)
  {
    super.setEnabled(paramBoolean);
    this.zzaen.setEnabled(paramBoolean);
  }
  
  public void setOnClickListener(View.OnClickListener paramOnClickListener)
  {
    this.zzaeo = paramOnClickListener;
    if (this.zzaen != null) {
      this.zzaen.setOnClickListener(this);
    }
  }
  ...
  {
    setStyle(paramInt, this.mColor, this.zzaem);
  }
  
  public void setStyle(int paramInt1, int paramInt2)
  {
    setStyle(paramInt1, paramInt2, this.zzaem);
  }
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/common/SignInButton.class
