  ...
  implements Cast.MessageReceivedCallback
{
  ...
  private final zzm zzZX = new zzm(null)
  {
  ...
  public long getApproximateStreamPosition()
  {
    ...
    {
      long l = this.zzZX.getApproximateStreamPosition();
      return l;
    }
  }
  ...
  public MediaInfo getMediaInfo()
  {
    synchronized (this.zzpK)
    {
      MediaInfo localMediaInfo = this.zzZX.getMediaInfo();
  ...
  public MediaStatus getMediaStatus()
  {
    synchronized (this.zzpK)
    {
      MediaStatus localMediaStatus = this.zzZX.getMediaStatus();
  ...
  public long getStreamDuration()
  {
    synchronized (this.zzpK)
    {
      long l = this.zzZX.getStreamDuration();
      return l;
    }
  }
  ...
  public PendingResult<MediaChannelResult> load(final GoogleApiClient paramGoogleApiClient, final MediaInfo paramMediaInfo, final boolean paramBoolean, final long paramLong, long[] paramArrayOfLong, final JSONObject paramJSONObject)
  {
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        ...
        {
          RemoteMediaPlayer.zzf(RemoteMediaPlayer.this).zzb(paramGoogleApiClient);
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF, paramMediaInfo, paramBoolean, paramLong, paramJSONObject, this.zzaal);
          }
          catch (IOException localIOException)
          {
            for (;;)
            {
              ...
              RemoteMediaPlayer.zzf(RemoteMediaPlayer.this).zzb(null);
            }
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zzc(this.zzaaF, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
      ...
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            ...
            zzo localzzo = this.zzaaF;
            MediaQueueItem localMediaQueueItem = paramMediaQueueItem;
            int i = paramInt;
            long l = paramLong;
            JSONObject localJSONObject = this.zzaal;
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF, paramArrayOfMediaQueueItem, paramInt, 0, -1, -1L, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF, paramInt, paramLong, null, 0, null, this.zzaal);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF, paramArrayOfMediaQueueItem, paramInt1, paramInt2, paramLong, this.zzaal);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        ...
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          if (paramInt2 < 0)
          {
            zzb(zzq(new Status(2001, String.format(Locale.ROOT, "Invalid request: Invalid newIndex %d.", new Object[] { Integer.valueOf(paramInt2) }))));
            return;
          }
        }
        if (i == paramInt2)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF, 0, -1L, null, 1, null, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF, paramArrayOfInt, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF, paramArrayOfInt, paramInt, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF, 0, -1L, null, 0, Integer.valueOf(paramInt), paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF, 0, -1L, paramArrayOfMediaQueueItem, 0, null, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF, paramLong, paramJSONObject, this.zzaal);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF, paramArrayOfLong);
          }
          catch (IOException localIOException)
          {
            for (;;)
  ...
  public PendingResult<MediaChannelResult> setStreamMute(final GoogleApiClient paramGoogleApiClient, final boolean paramBoolean, final JSONObject paramJSONObject)
  {
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      ...
      protected void zza(zze paramAnonymouszze)
      {
        // Byte code:
        //   0: aload_0
        //   1: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$22:zzaad	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   9: monitorenter
        //   10: aload_0
        //   11: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$22:zzaad	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   17: aload_0
        //   18: getfield 23	com/google/android/gms/cast/RemoteMediaPlayer$22:zzaae	Lcom/google/android/gms/common/api/GoogleApiClient;
        //   21: invokevirtual 50	com/google/android/gms/cast/RemoteMediaPlayer$zza:zzb	(Lcom/google/android/gms/common/api/GoogleApiClient;)V
        //   24: aload_0
        //   25: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$22:zzaad	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   31: aload_0
        //   32: getfield 58	com/google/android/gms/cast/RemoteMediaPlayer$22:zzaaF	Lcom/google/android/gms/cast/internal/zzo;
        //   35: aload_0
        //   36: getfield 25	com/google/android/gms/cast/RemoteMediaPlayer$22:zzaaA	Z
        //   39: aload_0
        //   40: getfield 27	com/google/android/gms/cast/RemoteMediaPlayer$22:zzaal	Lorg/json/JSONObject;
        ...
        //   46: pop2
        //   47: aload_0
        //   48: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$22:zzaad	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   54: aconst_null
        //   55: invokevirtual 50	com/google/android/gms/cast/RemoteMediaPlayer$zza:zzb	(Lcom/google/android/gms/common/api/GoogleApiClient;)V
        //   58: aload_1
        //   59: monitorexit
        //   60: return
        //   61: astore_2
        ...
        //   80: aload_0
        //   81: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$22:zzaad	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   87: aconst_null
        //   88: invokevirtual 50	com/google/android/gms/cast/RemoteMediaPlayer$zza:zzb	(Lcom/google/android/gms/common/api/GoogleApiClient;)V
        //   91: goto -33 -> 58
        //   94: astore_2
        //   95: aload_1
        //   96: monitorexit
        ...
        //   99: astore_2
        //   100: aload_0
        //   101: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$22:zzaad	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   107: aconst_null
        //   108: invokevirtual 50	com/google/android/gms/cast/RemoteMediaPlayer$zza:zzb	(Lcom/google/android/gms/common/api/GoogleApiClient;)V
        //   111: aload_2
        //   112: athrow
        //   113: astore_2
        //   114: goto -52 -> 62
    ...
    throws IllegalArgumentException
  {
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      ...
      protected void zza(zze paramAnonymouszze)
      {
        // Byte code:
        //   0: aload_0
        //   1: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$21:zzaad	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   9: monitorenter
        //   10: aload_0
        //   11: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$21:zzaad	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   17: aload_0
        //   18: getfield 23	com/google/android/gms/cast/RemoteMediaPlayer$21:zzaae	Lcom/google/android/gms/common/api/GoogleApiClient;
        //   21: invokevirtual 52	com/google/android/gms/cast/RemoteMediaPlayer$zza:zzb	(Lcom/google/android/gms/common/api/GoogleApiClient;)V
        //   24: aload_0
        //   25: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$21:zzaad	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   31: aload_0
        //   32: getfield 60	com/google/android/gms/cast/RemoteMediaPlayer$21:zzaaF	Lcom/google/android/gms/cast/internal/zzo;
        //   35: aload_0
        //   36: getfield 25	com/google/android/gms/cast/RemoteMediaPlayer$21:zzaaz	D
        //   39: aload_0
        //   40: getfield 27	com/google/android/gms/cast/RemoteMediaPlayer$21:zzaal	Lorg/json/JSONObject;
        ...
        //   46: pop2
        //   47: aload_0
        //   48: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$21:zzaad	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   54: aconst_null
        //   55: invokevirtual 52	com/google/android/gms/cast/RemoteMediaPlayer$zza:zzb	(Lcom/google/android/gms/common/api/GoogleApiClient;)V
        //   58: aload_1
        //   59: monitorexit
        //   60: return
        //   61: astore_2
        ...
        //   80: aload_0
        //   81: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$21:zzaad	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   87: aconst_null
        //   88: invokevirtual 52	com/google/android/gms/cast/RemoteMediaPlayer$zza:zzb	(Lcom/google/android/gms/common/api/GoogleApiClient;)V
        //   91: goto -33 -> 58
        //   94: astore_2
        //   95: aload_1
        //   96: monitorexit
        ...
        //   99: astore_2
        //   100: aload_0
        //   101: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$21:zzaad	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   107: aconst_null
        //   108: invokevirtual 52	com/google/android/gms/cast/RemoteMediaPlayer$zza:zzb	(Lcom/google/android/gms/common/api/GoogleApiClient;)V
        //   111: aload_2
        //   112: athrow
        //   113: astore_2
        //   114: goto -52 -> 62
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzaaF, paramTextTrackStyle);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zzb(this.zzaaF, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    implements zzn
  {
      ...
      throws IOException
    {
      ...
      Cast.CastApi.sendMessage(this.zzaaB, paramString1, paramString2).setResultCallback(new zza(paramLong));
    }
    
    public void zzb(GoogleApiClient paramGoogleApiClient)
    {
      this.zzaaB = paramGoogleApiClient;
    }
    
    public long zzny()
    {
      long l = this.zzaaC + 1L;
      this.zzaaC = l;
      return l;
    }
      ...
      implements ResultCallback<Status>
    {
      ...
      zza(long paramLong)
      {
        this.zzaaD = paramLong;
      }
      
      public void zzp(Status paramStatus)
      {
        if (!paramStatus.isSuccess()) {
          RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zzb(this.zzaaD, paramStatus.getStatusCode());
        }
      }
    }
  }
    ...
    extends zzb<RemoteMediaPlayer.MediaChannelResult>
  {
    zzo zzaaF = new zzo()
    {
      ...
      {
        RemoteMediaPlayer.zzb.this.zzb(RemoteMediaPlayer.zzb.this.zzq(new Status(2103)));
      }
    };
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/cast/RemoteMediaPlayer.class
