  ...
  implements Parcelable.Creator<FaceParcel>
{
  static void zza(FaceParcel paramFaceParcel, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 7, paramFaceParcel.zzbiI);
    zzb.zza(paramParcel, 8, paramFaceParcel.zzbiJ);
    zzb.zza(paramParcel, 9, paramFaceParcel.zzbiK, paramInt, false);
    zzb.zza(paramParcel, 10, paramFaceParcel.zzbiL);
    zzb.zza(paramParcel, 11, paramFaceParcel.zzbiM);
    zzb.zza(paramParcel, 12, paramFaceParcel.zzbiN);
    zzb.zzI(paramParcel, i);
  }
  
  public FaceParcel zzgX(Parcel paramParcel)
  {
  ...
  public FaceParcel[] zzkq(int paramInt)
  {
...
/* Location:              /Users/subdiox/Downloads/dex2jar-2.0/net.wargaming.wot.blitz-dex2jar.jar!/com/google/android/gms/vision/face/internal/client/zza.class
